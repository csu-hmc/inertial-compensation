...
%-------------------------------------------------------------------------
    ...
    %Accelerations
        accel=...
            [data.data(:,find(ismember(data.textdata,'Channel14.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel15.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel16.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel18.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel19.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel20.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel22.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel23.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel24.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel26.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel27.Anlg')))...
            data.data(:,find(ismember(data.textdata,'Channel28.Anlg')))];
    %Generating Output
